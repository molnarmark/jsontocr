...
class CrystalProperty {
  ...
  toString() {
    let defLine;
    if (this.isArray) {
      defLine = `${this.name}: {type: Array of ${capitalize(
        this.type
      )}, nilable: true},`;
    } else {
...
function convertProperty(name, value, arrayOf) {
  if (typeof value === 'object') {
    ...
    return new CrystalProperty(name, name);
  }
